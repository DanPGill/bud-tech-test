...
describe('#getExpensesOnly()', () => {
  [
    {
      input: [{ title: 'One', amount: { value: -20.0 } }, { title: 'Two', amount: { value: -150.0 } }, { title: 'Three', amount: { value: 100.0 } }],
      expectedOutput: [{ title: 'One', amount: { value: -20.0 } }, { title: 'Two', amount: { value: -150.0 } }],
    },
    ...
    [{ input: 'Hello', expectedOutput: TypeError }, { input: [{ title: 'One' }], expectedOutput: TypeError }].forEach(testParams => {
      it(`${testParams.input} should return ${testParams.expectedOutput}`, () => {
